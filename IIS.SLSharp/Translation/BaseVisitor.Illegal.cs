...
namespace IIS.SLSharp.Translation
{
    internal abstract partial class BaseVisitor
    {
        ...
        {
            throw new SLSharpException("HLSL does not understand anonymous methods.");
        }
        ...
        {
            throw new SLSharpException("HLSL primitives do not methods.");
        }
        ...
        {
            throw new SLSharpException("HLSL does not understand the fixed keyword.");
        }

        public StringBuilder VisitGotoCaseStatement(GotoCaseStatement gotoCaseStatement, int data)
        {
            throw new SLSharpException("HLSL cannot jump from one case to another.");
        }
        ...
        {
            throw new SLSharpException("HLSL does not allow unsafe code.");
        }

        public StringBuilder VisitUsingStatement(UsingStatement usingStatement, int data)
        {
            throw new SLSharpException("HLSL does not have the using keyword.");
        }

        public StringBuilder VisitYieldBreakStatement(YieldBreakStatement yieldBreakStatement, int data)
        {
            throw new SLSharpException("HLSL does not have iterators.");
        }
        ...
        {
            throw new SLSharpException("HLSL does not support pattern placeholders.");
        }

        public StringBuilder VisitNamedArgumentExpression(NamedArgumentExpression namedArgumentExpression, int data)
        {
            throw new SLSharpException("HLSL does not support named arguments.");
        }
    }
}
