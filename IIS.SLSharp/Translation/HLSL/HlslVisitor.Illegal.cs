...
namespace IIS.SLSharp.Translation.HLSL
{
    internal sealed partial class HlslVisitor
    {
        ...
        {
            throw new SLSharpException("GLSL can only operate in unchecked context.");
        }

        public StringBuilder VisitLambdaExpression(LambdaExpression lambdaExpression, int data)
        {
            throw new SLSharpException("GLSL does not understand lambda expressions.");
        }

        public StringBuilder VisitIsExpression(IsExpression isExpression, int data)
        {
            throw new SLSharpException("GLSL does not have reflection.");
        }
        ...
        {
            throw new SLSharpException("GLSL does not have pointers.");
        }

        public StringBuilder VisitSizeOfExpression(SizeOfExpression sizeOfExpression, int data)
        {
            throw new SLSharpException("GLSL has no sizeof operator.");
        }
        ...
        {
            throw new SLSharpException("GLSL primitives do not methods.");
        }

        public StringBuilder VisitQueryExpression(QueryExpression queryExpression, int data)
        {
            throw new SLSharpException("GLSL does not understand LINQ.");
        }
        ...
        {
            throw new SLSharpException("GLSL does not have attributes.");
        }
        ...
        {
            throw new SLSharpException("GLSL cannot jump from one case to another.");
        }
        ...
        {
            throw new SLSharpException("GLSL does not allow unsafe code.");
        }

        public StringBuilder VisitUsingStatement(UsingStatement usingStatement, int data)
        {
            throw new SLSharpException("GLSL does not have the using keyword.");
        }

        public StringBuilder VisitYieldBreakStatement(YieldBreakStatement yieldBreakStatement, int data)
        {
            throw new SLSharpException("GLSL does not have iterators.");
        }
