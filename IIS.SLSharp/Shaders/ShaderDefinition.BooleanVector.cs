...
namespace IIS.SLSharp.Shaders
{
    public abstract partial class ShaderDefinition
    {
        public sealed class bvec2
        {
            ...
            public bvec2 xx, xy, yx, yy;

            public bvec2 rr, rg, gr, gg;

            public bvec2 ss, st, ts, tt;

            public bvec3 xxx, xxy, xyx, xyy, yxx, yxy, yyx, yyy;

            public bvec3 rrr, rrg, rgr, rgg, grr, grg, ggr, ggg;

            public bvec3 sss, sst, sts, stt, tss, tst, tts, ttt;

            public bvec4 xxxx, xxxy, xxyx, xxyy, xyxx, xyxy, xyyx, xyyy,
                yxxx, yxxy, yxyx, yxyy, yyxx, yyxy, yyyx, yyyy;

            public bvec4 rrrr, rrrg, rrgr, rrgg, rgrr, rgrg, rggr, rggg,
                grrr, grrg, grgr, grgg, ggrr, ggrg, gggr, gggg;

            public bvec4 ssss, ssst, ssts, sstt, stss, stst, stts, sttt,
                tsss, tsst, tsts, tstt, ttss, ttst, ttts, tttt;

            public bvec2(bool xy) { throw _invalidAccess; }

            public bvec2(bool x, bool y) { throw _invalidAccess; }
        }
        ...
        public sealed class bvec3
        {
            ...
            public bvec2 ss, st, sp, ts, tt, tp, ps, pt, pp;

            public bvec3 xxx, xxy, xxz, xyx, xyy, xyz, xzx, xzy, xzz,
                yxx, yxy, yxz, yyx, yyy, yyz, yzx, yzy, yzz,
                zxx, zxy, zxz, zyx, zyy, zyz, zzx, zzy, zzz;

            public bvec3 rrr, rrg, rrb, rgr, rgg, rgb, rbr, rbg, rbb,
                grr, grg, grb, ggr, ggg, ggb, gbr, gbg, gbb,
                brr, brg, brb, bgr, bgg, bgb, bbr, bbg, bbb;

            public bvec3 sss, sst, ssp, sts, stt, stp, sps, spt, spp,
                tss, tst, tsp, tts, ttt, ttp, tps, tpt, tpp,
                pss, pst, psp, pts, ptt, ptp, pps, ppt, ppp;

            public bvec4 xxxx, xxxy, xxxz, xxyx, xxyy, xxyz, xxzx, xxzy, xxzz,
            ...
            public bvec4 rrrr, rrrg, rrrb, rrgr, rrgg, rrgb, rrbr, rrbg, rrbb,
            ...
            public bvec4 ssss, ssst, sssp, ssts, sstt, sstp, ssps, sspt, sspp,
            ...
            public bvec3(bool xyz) { throw _invalidAccess; }

            public bvec3(bvec2 xy, bool z) { throw _invalidAccess; }

            public bvec3(bool x, bvec2 yz) { throw _invalidAccess; }

            public bvec3(bool x, bool y, bool z) { throw _invalidAccess; }
        }
        ...
        public sealed class bvec4
        {
            ...
            public bvec2 ss, st, sp, sq, ts, tt, tp, tq, ps, pt, pp, pq, qs, qt, qp, qq;

            public bvec3 xxx, xxy, xxz, xxw, xyx, xyy, xyz, xyw, xzx, xzy, xzz, xzw, xwx, xwy, xwz, xww,
            ...
            public bvec3 rrr, rrg, rrb, rra, rgr, rgg, rgb, rga, rbr, rbg, rbb, rba, rar, rag, rab, raa,
            ...
            public bvec3 sss, sst, ssp, ssq, sts, stt, stp, stq, sps, spt, spp, spq, sqs, sqt, sqp, sqq,
            ...
            public bvec4 rrrr, rrrg, rrrb, rrra, rrgr, rrgg, rrgb, rrga, rrbr, rrbg, rrbb, rrba, rrar, rrag, rrab, rraa,
            ...
            public bvec4 ssss, ssst, sssp, sssq, ssts, sstt, sstp, sstq, ssps, sspt, sspp, sspq, ssqs, ssqt, ssqp, ssqq,
            ...
            public bvec4(bool xyzw) { throw _invalidAccess; }

            public bvec4(bool x, bool y, bool z, bool w) { throw _invalidAccess; }

            public bvec4(bvec2 xy, bool z, bool w) { throw _invalidAccess; }

            public bvec4(bool x, bvec2 yz, bool w) { throw _invalidAccess; }

            public bvec4(bool x, bool y, bvec2 zw) { throw _invalidAccess; }

            public bvec4(bvec2 xy, bvec2 zw) { throw _invalidAccess; }
